    ...
    <div class="mid-box-background">
      ...
      <div class="buttons-wrapper"></div>
        ...
        <div class="App-content">
          <div class="ui container stackable grid" id="mainOpeningContentWrap">
            <div
              id="OpeningContentWrapperWrap"
              class="sixteen wide tablet twelve wide computer column"
            >
              <div id="OpeningContentWrapper">
                <h1>👋 Welcome to my website!</h1>
                <p>
                  As you might have read in the title, my name is Nicholas Griffin and I am a web developer, blogger and
                  technology enthusiast from the UK.
                </p>
                <p>
                  I spend most of my time doing a range of personal web development projects around the web alongside my work
                  for Accrosoft, where I work as a developer and deliver a range of web-based projects for our customers around
                  the globe.
                </p>
                <p>
                  Before I started at Accrosoft, I worked for myself on various freelance web development projects and on my
                  own technology news & reviews site that was called TechNutty (still not a fan of the name). I also spent a few
                  years at the University of Derby, mostly drinking and playing Xbox, occasionally I studied Business Management
                  and somehow managed to achieve a 2:1, which is fair enough. 😂
                </p>
                <p>
                  I aim to use this website to not only showcase myself but also start working on a range of other personal
                  projects. You can follow my expeditions below.
                </p>
            ...
            <div id="MusicOpeningWrapper" class="sixteen wide tablet four wide computer column">
              <div id="spotify-widget" class="ui stackable grid"></div>
          ...
          <div id="BlogandMoreAboutWrapper" class="conntainer-fluid coloured-container">
            <div class="ui container">
              <div id="BlogPostOpenerWrapper">
                <h2>What's going on?</h2>
                <p>
                  Below you will find some of the blog posts that I have wrote (if that is still working), I used to write a
                  lot and I'm looking to write blog posts more about the projects that I am working on. There might not be a
                  lot here but I hope that it will at least be interesting, at least to me.
                </p>
              </div>
            </div>
          </div>
          <div
            ...
            class="conntainer-fluid coloured-float-container"
          >
            <div class="ui container">
                <ArticleList :isPaginated="false" :postsPerPage="6"/>
              <button
          ...
          <div id="ExtraContentWrapper" class="ui container">
            <div id="ExtraContentContainer">
              <h2>So what is it that you do? 🤔</h2>
              <small>I'm not sure that I actually know but here's some of my public Github stuff:</small>
              <div class="ui three stackable cards" id="githubReposContainer"></div>
            </div>
            <div id="SkillsContentContainer">
              <h3>Languages that I often write in</h3>
              <div class="ui grid">
                <div class="doubling eight column row">
                  <div class="column icon-grid-item">
                    <img class="lazy" alt="CSS3" data-src="/uploads/langaugesIcons/css3.svg">
                    <span>CSS3</span>
                  </div>
                  <div class="column icon-grid-item">
                    <img class="lazy" alt="GraphQL" data-src="/uploads/langaugesIcons/graphql.svg">
                    <span>GraphQL</span>
                  </div>
                  <div class="column icon-grid-item">
                    <img class="lazy" alt="HTML5" data-src="/uploads/langaugesIcons/html5.svg">
                    <span>HTML5</span>
                  </div>
                  <div class="column icon-grid-item">
                    <img
                      class="lazy"
                      alt="JavaScript"
                      data-src="/uploads/langaugesIcons/javascript.svg"
                    >
                    <span>JavaScript</span>
                  </div>
                  <div class="column icon-grid-item">
                    <img class="lazy" alt="SASS" data-src="/uploads/langaugesIcons/sass.svg">
                    <span>SASS</span>
                  </div>
                  <div class="column icon-grid-item">
                    <img class="lazy" alt="JSON" data-src="/uploads/langaugesIcons/json.svg">
                    <span>JSON</span>
                  </div>
                  <div class="column icon-grid-item">
                    <img class="lazy" alt="PHP" data-src="/uploads/langaugesIcons/php.svg">
                    <span>PHP</span>
                  </div>
                  <div class="column icon-grid-item">
                    <img class="lazy" alt="React" data-src="/uploads/langaugesIcons/react.svg">
                    <span>React (JSX)</span>
                  </div>
                </div>
              </div>
                ...
                <div class="doubling eight column row">
                  <div class="column icon-grid-item">
                    <img
                      class="lazy"
                      alt="Bootstrap"
                      data-src="/uploads/langaugesIcons/bootstrap.svg"
                    >
                    <span>Bootstrap</span>
                  </div>
                  <div class="column icon-grid-item">
                    <img
                      class="lazy"
                      alt="CloudFlare"
                      data-src="/uploads/langaugesIcons/cloudflare.svg"
                    >
                    <span>CloudFlare</span>
                  </div>
                  <div class="column icon-grid-item">
                    <img class="lazy" alt="NPM" data-src="/uploads/langaugesIcons/npm.svg">
                    <span>NPM</span>
                  </div>
                  <div class="column icon-grid-item">
                    <img
                      class="lazy"
                      alt="Firebase"
                      data-src="/uploads/langaugesIcons/firebase.svg"
                    >
                    <span>Firebase</span>
                  </div>
                  <div class="column icon-grid-item">
                    <img class="lazy" alt="Gatsby" data-src="/uploads/langaugesIcons/gatsby.svg">
                    <span>Gatsby</span>
                  </div>
                  <div class="column icon-grid-item">
                    <img class="lazy" alt="Git" data-src="/uploads/langaugesIcons/git.svg">
                    <span>Git</span>
                  </div>
                  <div class="column icon-grid-item">
                    <img
                      ...
                      data-src="/uploads/langaugesIcons/googleanalytics.svg"
                    >
                    <span>Google Analytics</span>
                  </div>
                  <div class="column icon-grid-item">
                    <img class="lazy" alt="NGinx" data-src="/uploads/langaugesIcons/nginx.svg">
                    <span>NGINX</span>
                  </div>
                </div>
                <div class="doubling eight column row">
                  <div class="column icon-grid-item">
                    <img class="lazy" alt="NodeJS" data-src="/uploads/langaugesIcons/nodejs.svg">
                    <span>NodeJS</span>
                  </div>
                  <div class="column icon-grid-item">
                    <img class="lazy" alt="Docker" data-src="/uploads/langaugesIcons/docker.svg">
                    <span>Docker</span>
                  </div>
                  <div class="column icon-grid-item">
                    <img class="lazy" alt="AWS" data-src="/uploads/langaugesIcons/aws.svg">
                    <span>AWS</span>
                  </div>
                  <div class="column icon-grid-item">
                    <img class="lazy" alt="Sentry" data-src="/uploads/langaugesIcons/sentry.svg">
                    <span>Sentry</span>
                  </div>
                  <div class="column icon-grid-item">
                    <img class="lazy" alt="Yarn" data-src="/uploads/langaugesIcons/yarn.svg">
                    <span>Yarn</span>
                  </div>
                  <div class="column icon-grid-item">
                    <img
                      ...
                      data-src="/uploads/langaugesIcons/visualstudiocode.svg"
                    >
                    <span>Visual Studio / Code</span>
                  </div>
                  <div class="column icon-grid-item">
                    <img class="lazy" alt="Webpack" data-src="/uploads/langaugesIcons/webpack.svg">
                    <span>Webpack</span>
                  </div>
                  <div class="column icon-grid-item">
                    <img
                      class="lazy"
                      alt="WordPress"
                      data-src="/uploads/langaugesIcons/wordpress.svg"
                    >
                    <span>WordPress</span>
                  </div>
                </div>
                ...
                <div class="doubling one column row">
                  <div class="column icon-grid-item">
                    <img
                      class="lazy"
                      alt="Stack Overflow"
                      data-src="/uploads/langaugesIcons/stackoverflow.svg"
                    >
          ...
          <footer id="App-footer">
            <div class="ui container">
              <div class="footerBlockFloat"></div>
